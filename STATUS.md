...
| 站点页面 | 6：落地页 + 四条业务线入口 + 1 个具体案例（大数据导论实践课任务书） |
...
| 具体案例覆盖四条业务线 | 只有课堂教学这一条业务线有具体案例页（大数据导论实践课）；数据、云、咨询三条只有入口介绍 | ✗ 待补 |
...
工作案例库现在是**「四条业务线的介绍 + 一个具体案例」**：入口齐了、站修好了、口径立住了，欠的是内容——每条业务线下都还没有能拿出去看的完整案例。
